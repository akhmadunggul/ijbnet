...
### Recent changes
- v0.9.6 — CV: LPK name field in all six templates, configurable display mode (same page / new tab) from superadmin; fix new-tab CV login race; fix EPSS empty columns
